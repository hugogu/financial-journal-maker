...
/**
 * Scenario entity representing a business scenario under a Product.
 * Middle level of the hierarchy: Product → Scenario → TransactionType.
 */
@Entity
@Table(name = "scenarios",
       uniqueConstraints = @UniqueConstraint(name = "uk_scenario_product_code", 
...
public class Scenario {
    ...
    @Column(name = "fund_flow_path", columnDefinition = "TEXT")
